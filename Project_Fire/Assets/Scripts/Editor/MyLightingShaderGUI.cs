...
public class MyLightingShaderGUI : ShaderGUI {
    ...
    void DoOutline()
    {
        ...
        EditorGUI.BeginChangeCheck();
        editor.ShaderProperty(outlineWidth, MakeLabel(outlineWidth));
        editor.ShaderProperty(outlineColor, MakeLabel(outlineColor));
    }

    void DoGradient()
    {
        MaterialProperty gradient = FindProperty("_RampTexture");
        EditorGUI.BeginChangeCheck();
        editor.TexturePropertySingleLine(MakeLabel(gradient), gradient);
    }
    ...
    void DoShadowColor()
    {
        ...
        EditorGUI.BeginChangeCheck();
        editor.ShaderProperty(shadowColor, MakeLabel(shadowColor));
    }
